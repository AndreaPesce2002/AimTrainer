...
# ------------ creazione  elementi in scermata -----------
    ...
    b = pygame.image.load('images\\restart.png').convert_alpha()
    screen.blit(b, buttonReset)

    b1 = pygame.image.load('images\\facile.png').convert_alpha()
    screen.blit(b1, buttonFacile)

    b2 = pygame.image.load('images\medio.png').convert_alpha()
    screen.blit(b2, buttonMedio)

    b3 = pygame.image.load('images\difficile.png').convert_alpha()
    screen.blit(b3, buttonDifficile)

    b4 = pygame.image.load('images\pazzia.png').convert_alpha()
